...
function pmxi_admin_menu() {
	...
	if (current_user_can(PMXI_Plugin::$capabilities)) { // admin management options
		...
		add_menu_page(__('WP All Import - GFXFree.Net', 'wp_all_import_plugin'), __('All Import', 'wp_all_import_plugin'), PMXI_Plugin::$capabilities, 'pmxi-admin-home', array(PMXI_Plugin::getInstance(), 'adminDispatcher'), PMXI_Plugin::ROOT_URL . '/static/img/xmlicon.png', 112);
